...
class MiniConnect4Player(Connect4Player):
    ...
    def minimax(self, state: Connect4State, depth, alpha, beta, maximizingPlayer):
        ...
        if depth == 0 or state.is_finished():
            ...
            if result is not None:
                ...
                return None, MiniConnect4Player.score_position(state.get_grid(), current_player)
    ...
    def score_position(grid, piece):
        ...
        for r in range(len(grid)):
            ...
            for c in range(len(grid[0]) - 3):
                ...
                score += MiniConnect4Player.evaluate_window(window, piece)
